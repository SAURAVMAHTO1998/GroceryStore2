<template>
    <form @submit.prevent="signup">
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <h1 class="h3">Sign up to Grocery Store <img src="@/assets/logo.png" width="50" height="50" alt=""> </h1>
                </div>
            </div>
            <div class="row ">
                <div class="col-sm">
            ...
            <div class="row">
                <div v-if="status === 'success'" class="col-sm">
                    <router-link to="/login" class="w-100 btn btn-lg btn-outline-primary" role="button">Sign
                        In</router-link>
                </div>
            </div>
        </div>
