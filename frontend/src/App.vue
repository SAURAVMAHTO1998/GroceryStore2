  ...
  <div id="app">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <img src="./assets/groc_icon.jpg" width="50" height="50">
        <a class="navbar-brand" href="">&nbsp;The Grocery Store</a>
        <div class="collapse navbar-collapse" id="navbarElements">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="profileDropdown">
                ...
                <div v-else>
                  ...
                  <router-link to="/mycart" class="dropdown-item">Cart</router-link>
          ...
          <form class="d-flex" @submit.prevent="searchProducts">
            <input class="form-control mr-sm-2" type="search" placeholder="Search Products" v-model="searchTerm">
